    ...
    <>
      ...
      <section className="section">
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <h2 className="reveal reveal-delay-1">Des espaces à vivre<br />dans votre jardin</h2>
          <p
            className="reveal reveal-delay-2"
            style={{ maxWidth: 560, margin: '0 auto 40px' }}
          >
            Compactes, design et fonctionnelles — nos capsules transforment
            votre extérieur en véritable espace de vie. Livrées clé en main,
            prêtes à l&apos;emploi.
          </p>

          <div className="products-grid" style={{ textAlign: 'left', marginBottom: 48 }}>
            {/* Capsule 1 */}
            <div className="product-card reveal reveal-delay-1">
              <div className="product-card-image">
                <span className="coming-badge">À venir</span>
                <svg width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" className="product-placeholder-icon">
              ...
              <div className="product-card-body">
                <h3>Capsule Solo</h3>
                <div className="product-subtitle">20 m² — Studio tout confort</div>
                <p>Un espace compact et lumineux, idéal pour un bureau, un studio d'appoint ou une chambre d'hôtes.</p>
              </div>
            </div>
            ...
            <div className="product-card reveal reveal-delay-2">
              ...
              <div className="product-card-body">
                ...
                <p>Un véritable petit logement avec espace nuit séparé. Parfait pour un proche, un locataire ou un studio de création.</p>
              </div>
            </div>
            ...
            <div className="product-card reveal reveal-delay-3">
              ...
              <div className="product-card-body">
                <h3>Capsule Family</h3>
                <div className="product-subtitle">45 m² — 3 pièces</div>
                <p>Notre plus grand modèle : un véritable espace de vie familial, avec chambres, salon et cuisine équipée.</p>
              </div>
            </div>
          </div>

          <a href="/produit" className="btn btn-primary reveal reveal-delay-4">
            En savoir plus
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginTop: 1 }}>
              <path d="M5 12h14"/>
              <path d="M12 5l7 7-7 7"/>
